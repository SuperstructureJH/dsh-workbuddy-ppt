...
export declare function OfficePptHeroActions({ client, mode, sessionId, t, }: PropsRuntime<'conversation.hero.actions'> & InjectFace<OfficePptHeroInjected> & PropsLocale<'office-ppt'>): import("react").JSX.Element;
export {};
